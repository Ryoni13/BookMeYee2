...
'광주 쌍촌동', 35.15204, 126.863, MEMNUM_SEQ.NEXTVAL);
insert into membertable values('김리현', 'asd','asd','010', 20,
'광주 치평동', 35.15325, 126.8446, MEMNUM_SEQ.NEXTVAL);
insert into membertable values('이향선', 'zxc','zxc','010', 20,
'광주 첨단2지구', 35.21419, 126.8693, MEMNUM_SEQ.NEXTVAL);
